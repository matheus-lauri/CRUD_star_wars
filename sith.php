...
<body>
    ...
    $sith = new Sith();
    $listaDeSith = $sith->listar();

    if (isset($_POST['nomsith'])) {
    }
    ?>
    ...
    <div class="d-flex px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center ">
        <div class=" text-center ">
            ...
            <table class="table table-hover">
                <thead>
                    ...
                    <tr class="table">
                        ...
                        <td style="color: #fff;">Nome do Sith</td>
                ...
                <tbody>
                    <?php foreach ($listaDeSith as $s) { ?>
                        <tr class="table">
                            <td style="color: #b3b3b3;"><i style="color: #e5b13a;" class="fas fa-user"></i> <?php echo $s['codsit']; ?></td>
                            <td style="color: #b3b3b3;"><a style="color: #b3b3b3;" href="editar_sith.php?codsit=<?php echo $s['codsit']; ?>"> <?php echo $s['nomsit']; ?><i style="color: #e5b13a;" class="far fa-edit"></i></a> </td>
                            <td><a style="color:#b3b3b3;" href="eliminar_sith.php?codsit=<?php echo $s['codsit']; ?>">Eliminar<i style="color: #e5b13a;" class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php } ?>
            ...
            <center>
                <a class="col-md-12" href="adicionar_sith.php"><button  type="submit" class="btn btn-primary btn-xl">Adicionar um novo Sith</button></a>
            </center>
        </div>
    </div>
