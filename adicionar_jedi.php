...
<body id="page-top">
    ...
    if (isset($_POST['nomjed'])) {
        ...
        $jed = new Jedi();
        $jed->inserir($_POST['nomjed']);
    }
    ?>

    <?php if (isset($_POST['nomjed'])) { ?>
        <script>
            alert('Novo Jedi inserido com sucesso!');
        </script>
    <?php } ?>
    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    <center>
                        <form action="adicionar_jedi.php" method="post">
                            <div class="mb-3 col-10 col-md-12" style="text-align: initial;">
                                <label for="nome" class="form-label" style="text-align: inherit;color:#fff">Adicione um nome para o novo Jedi:</label>
                                <input type="text" class="form-control" id="nomjed" name="nomjed">
                            </div>
