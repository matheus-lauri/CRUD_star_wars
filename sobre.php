...
<body id="page-top">
    ...
    <!-- Link para algumas animações de star wars em css 
        https://cgreinhold.dev/2021/05/20/star-wars/ --> 
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h4 class="text-white font-weight-bold perspective2">Desenvolvedores do CRUD:</h4>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline ">
                    <p class="text-white-75 mb-5 "><img src="./assets/img/Foppa.png" alt="..." width="300px" ><img src="./assets/img/Matheus.png" alt="..." width="300px" ></p>
                    <hr class="divider" />
                    <p class="text-white-75 mb-5 perspective2">Guilherme H. Foppa e Matheus Baron Lauritzen</p>
