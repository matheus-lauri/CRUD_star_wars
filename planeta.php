...
<body>
    ...
    <div class="d-flex px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center ">
        <div class=" text-center ">
                ...
                <tbody>
                    <?php foreach ($listaDePlaneta as $p) { ?>
                        <tr class="table">
                            ...
                            <td style="color: #b3b3b3;"><a style="color: #b3b3b3;" href="editar_planeta.php?codpla=<?php echo $p['codpla']; ?>"> <?php echo $p['nompla']; ?><i style="color: #e5b13a;" class="far fa-edit"></i></a> </td>
                            <td><a style="color:#b3b3b3;" href="eliminar_planeta.php?codpla=<?php echo $p['codpla']; ?>">Eliminar<i style="color: #e5b13a;" class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php } ?>
            ...
            <center>
                <a class="col-md-12" href="adicionar_planeta.php"><button  type="submit" class="btn btn-primary btn-xl">Adicionar um novo Planeta</button></a>
            </center>
        </div>
    </div>
